...
from ma_dip_rsi_buy.backtest import (
...
class TestRunBacktest:
    ...
    def test_no_trades(self):
        ...
        result = run_backtest(df, x=5, m=10, n=10, k=15, t=10, rsi_threshold=50)
    ...
    def test_has_trades(self):
        ...
        df = self._make_df(closes)
        result = run_backtest(df, x=5, m=5, n=10, k=15, t=10, rsi_threshold=50)
        assert result.n_trades > 0
